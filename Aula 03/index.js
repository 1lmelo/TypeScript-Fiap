var Bioquimico = /** @class */ (function () {
    ...
    Bioquimico.prototype.calcularEMostrarMassaMolar = function (formula) {
        ...
        return "O bioqu\u00EDmico ".concat(this.nome, " calculou a massa do ").concat(formula, " e chegou no n\u00FAmero de ").concat(massaMolar);
    };
    return Bioquimico;
}());
var bioquimico = new Bioquimico("Lucas");
console.log(bioquimico.calcularEMostrarMassaMolar("H2O"));
console.log(bioquimico.calcularEMostrarMassaMolar("CO2"));
console.log(bioquimico.calcularEMostrarMassaMolar("H"));
